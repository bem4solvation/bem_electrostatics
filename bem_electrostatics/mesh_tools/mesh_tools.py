...
def convert_pdb2pqr(mesh_pdb_path, mesh_pqr_path, force_field):
    ...
    try:
        ...
        print('Error finding pdb2pqr, please check it is installed and '
              'available via the terminal as "pdb2pqr30" command.')
...
def density_to_nanoshaper_grid_scale_conversion(mesh_density):
    # Empirical relation found by creating meshes using nanoshaper and calculating their density
